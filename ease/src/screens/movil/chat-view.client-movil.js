...
function ChatClientMovil() {
    ...
    const handleWebSocketMessages = (event) => {
        ...
        if (Array.isArray(rawMessages)) {
            ...
            setMessages(prevMessages => [...prevMessages, ...formattedMessages].sort((a, b) => a.createdAt - b.createdAt));
            ...
            setMessages(prevMessages => [...prevMessages, formattedMessage].sort((a, b) => a.createdAt - b.createdAt));
        } else {
...
export default ChatClientMovil;